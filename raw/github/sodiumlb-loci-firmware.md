...
- Primary language: C
- Default branch: main
- Latest release: v0.3.1 (about 1 year ago)
- License: BSD 3-Clause "New" or "Revised" License
- Homepage: (none)
- Fetched: 2026-05-17
- Final URL: https://github.com/sodiumlb/loci-firmware
...
- .gitmodules — submodule references (pico-sdk, tinyusb, fatfs, littlefs, pico-extras)
- .vscode/ — VS Code editor configuration
- CMakeLists.txt — top-level CMake build configuration
- LICENSE — BSD 3-Clause license
- README.md — project documentation
- examples/ — sample programs (blink, helloworld_64tass, helloworld_cc65, rp6502.py helper)
- src/ — firmware source code (CMakeLists.txt, fatfs/, littlefs submodule, memmap_xram_mia.ld, mia/ core, pico-extras/pico-sdk/tinyusb submodules)
