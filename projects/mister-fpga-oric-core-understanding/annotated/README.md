...
- `rtl/spram.v` — generic single-port RAM (2026-07-27, sprint Day 1)
- `rtl/T65/T65.vhd` — 6502 CPU soft core; **interface annotated only**, internals
  deliberately out of scope (2026-07-27, sprint Day 1)
- `rtl/rom/README.md` — annotates the ROM-file *pattern* instead of copying 13 hex
  dumps; also records which ROMs are actually in the build (2026-07-27, Day 1)
...
- **2026-07-27 — `Oric.sv` line 150.** The `★ RESET & RAM CLEAR` comment said the reset
